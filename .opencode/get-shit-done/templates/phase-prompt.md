...
<!-- For checkpoint task examples and patterns, see @/home/othavio/Work/agent-bar-usage/.opencode/get-shit-done/references/checkpoints.md -->
...
See `/home/othavio/Work/agent-bar-usage/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/othavio/Work/agent-bar-usage/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/othavio/Work/agent-bar-usage/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
