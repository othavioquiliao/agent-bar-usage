...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/othavio/Work/noctua/agent-bar-usage/.claude
                  → checks /home/othavio/Work/noctua/agent-bar-usage/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/othavio/Work/noctua/agent-bar-usage/.claude/get-shit-done
                  → writes to /home/othavio/Work/noctua/agent-bar-usage/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/home/othavio/Work/noctua/agent-bar-usage/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/othavio/Work/noctua/agent-bar-usage/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/othavio/Work/noctua/agent-bar-usage/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
