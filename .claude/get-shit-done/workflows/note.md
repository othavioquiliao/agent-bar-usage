...
- **Global scope**: `/home/othavio/Work/agent-bar-usage/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/othavio/Work/agent-bar-usage/.claude/notes/`)
...
2. Glob `/home/othavio/Work/agent-bar-usage/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/othavio/Work/agent-bar-usage/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/othavio/Work/agent-bar-usage/.claude/notes/` — works in any directory
