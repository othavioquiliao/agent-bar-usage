...
- Usage: Reference from command with `@/home/othavio/Work/agent-bar-usage/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/othavio/Work/agent-bar-usage/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/othavio/Work/agent-bar-usage/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
