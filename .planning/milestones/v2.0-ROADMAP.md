...
**Plans:** 3 plans
Plans:
- [x] 10-01-PLAN.md -- Replace Zod runtime validation with inline guards/assertions across shared-contract and backend callers
- [x] 10-02-PLAN.md -- Rewrite CLI around manual parsing, direct runners, typo suggestions, and boxed help output
- [x] 10-03-PLAN.md -- Adopt Biome, remove obsolete Commander/Zod dependencies, and refresh lockfiles
...
**Plans:** 3 plans
Plans:
- [x] 11-01-PLAN.md -- Provider contract metadata, registry cleanup, and config-backed `agent-bar providers`
- [x] 11-02-PLAN.md -- File-backed snapshot cache, TTL/dedup behavior, and service-owned auto-refresh/startup hydration
- [x] 11-03-PLAN.md -- Locale-aware CLI formatting, dynamic GNOME indicator ordering, and packaged provider icon wiring
**UI hint**: yes
...
**Plans:** 3 plans
Plans:
- [x] 12-01-PLAN.md -- Interactive menu shell, TTY-aware no-args entrypoint, and guided provider login flows
- [x] 12-02-PLAN.md -- Rich terminal snapshot formatter with One Dark ANSI palette and Unicode progress bars
- [x] 12-03-PLAN.md -- Interactive doctor presenter, auth cleanup, and explicit OAuth blocker capture
